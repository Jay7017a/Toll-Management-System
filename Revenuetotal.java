...
public class Revenuetotal extends Payment {
	...
	static void inCompletedVehiclesPayemtPendingList() {
		if (suspendedPendingvehicles!=0) {
			System.out.println();
			System.out.println("-----TOTAL REVENUE-------");
			System.out.println("Vehicles List Pending Payment 		  : " + suspendedPendingvehiclesPayment);
			System.out.println("Count of Vehicles Pending Payment Done 			  : " + suspendedPendingvehicles);
			System.out.println("Total Revenue Pending Payment Vehicles: " + remainingPerVehiclePayment);
